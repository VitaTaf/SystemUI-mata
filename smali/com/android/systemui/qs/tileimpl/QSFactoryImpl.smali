...
.method private createTileInternal(Ljava/lang/String;)Lcom/android/systemui/qs/tileimpl/QSTileImpl;
    ...
    .line 163
    :pswitch_6
    new-instance p1, Lcom/android/systemui/qs/tiles/WifiCallingTile;

    iget-object p0, p0, Lcom/android/systemui/qs/tileimpl/QSFactoryImpl;->mHost:Lcom/android/systemui/qs/QSTileHost;

    invoke-direct {p1, p0}, Lcom/android/systemui/qs/tiles/WifiCallingTile;-><init>(Lcom/android/systemui/qs/QSHost;)V
    ...
    .sparse-switch
        ...
        -0x285a60ae -> :sswitch_10
        -0x13be51f3 -> :sswitch_f
        -0x266f082 -> :sswitch_e
        0xc52 -> :sswitch_d
        0x1851a -> :sswitch_c
        0x1a9ab -> :sswitch_b
