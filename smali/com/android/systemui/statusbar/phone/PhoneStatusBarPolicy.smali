...
.field private final mSlotWifiCalling:Ljava/lang/String;
...
.field private final mWifiCallingCallback:Lcom/android/systemui/statusbar/policy/WifiCallingController$Callback;

.field private final mWifiCallingController:Lcom/android/systemui/statusbar/policy/WifiCallingController;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBarIconController;)V
    ...
    .line 103
    iput-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mSlotWifiCalling:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mWifiCallingCallback:Lcom/android/systemui/statusbar/policy/WifiCallingController$Callback;
    ...
    .line 142
    const-class p2, Lcom/android/systemui/statusbar/policy/WifiCallingController;

    invoke-static {p2}, Lcom/android/systemui/Dependency;->get(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lcom/android/systemui/statusbar/policy/WifiCallingController;

    iput-object p2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mWifiCallingController:Lcom/android/systemui/statusbar/policy/WifiCallingController;
    ...
    invoke-virtual {v2, v3, p2, v5, v4}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    invoke-interface {p2, v2, v3, v5}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIcon(Ljava/lang/String;ILjava/lang/CharSequence;)V
    ...
    invoke-interface {p2, v2, v1}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIconVisibility(Ljava/lang/String;Z)V
    ...
    sget v5, Lcom/android/systemui/R$string;->accessibility_status_bar_hotspot:I
    ...
    invoke-static {p2}, Lcom/android/systemui/wificalling/ImsReceiver;->wfcNeedsAttention(Landroid/content/Context;)Z

    move-result p2

    if-nez p2, :cond_0

    sget p2, Lcom/android/systemui/R$drawable;->stat_sys_wfc_on:I

    goto :goto_0

    :cond_0
    sget p2, Lcom/android/systemui/R$drawable;->stat_sys_wfc_off:I
    ...
    sget v4, Lcom/android/systemui/R$string;->quick_settings_wfc_label:I

    invoke-virtual {v3, v4}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v0, p2, v3}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIcon(Ljava/lang/String;ILjava/lang/CharSequence;)V

    .line 222
    iget-object p2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mIconController:Lcom/android/systemui/statusbar/phone/StatusBarIconController;

    invoke-interface {p2, v0, v1}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIconVisibility(Ljava/lang/String;Z)V

    .line 223
    iget-object p2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mWifiCallingController:Lcom/android/systemui/statusbar/policy/WifiCallingController;

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mContext:Landroid/content/Context;

    invoke-interface {p2, v0}, Lcom/android/systemui/statusbar/policy/WifiCallingController;->setContext(Landroid/content/Context;)V

    .line 224
    iget-object p2, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mWifiCallingController:Lcom/android/systemui/statusbar/policy/WifiCallingController;

    iget-object v0, p0, Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;->mWifiCallingCallback:Lcom/android/systemui/statusbar/policy/WifiCallingController$Callback;

    invoke-interface {p2, v0}, Lcom/android/systemui/statusbar/policy/WifiCallingController;->addCallback(Lcom/android/systemui/statusbar/policy/WifiCallingController$Callback;)V
    ...
    .line 227
    invoke-interface {p2, v0, v2, v3}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIcon(Ljava/lang/String;ILjava/lang/CharSequence;)V
    ...
    invoke-interface {p2, v0, v2}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIconVisibility(Ljava/lang/String;Z)V
    ...
    .line 232
    invoke-interface {p2, v0, v2, p1}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIcon(Ljava/lang/String;ILjava/lang/CharSequence;)V
    ...
    .line 236
    invoke-interface {p1, p2, v0, v2}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIcon(Ljava/lang/String;ILjava/lang/CharSequence;)V
...
.method static synthetic access$1200(Lcom/android/systemui/statusbar/phone/PhoneStatusBarPolicy;I)V
    .locals 0
